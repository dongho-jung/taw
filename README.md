...
- 🤖 Working
- 💬 Waiting (user input required / needs attention)
- ✅ Done
...
When you first run `paw`, the setup wizard appears and initializes the configuration. PAW automatically uses worktree mode for git repositories.
