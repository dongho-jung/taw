...
func TestFileAndDirNames(t *testing.T) {
	...
	names := map[string]string{
		...
		"OriginLinkName":        OriginLinkName,
		"WorktreeDirName":       WorktreeDirName,
		"StatusFileName":        StatusFileName,
		"SessionStartedFile":    SessionStartedFile,
		"AgentSystemPromptFile": AgentSystemPromptFile,
		"AgentUserPromptFile":   AgentUserPromptFile,
		"VerifyLogFile":         VerifyLogFile,
		"VerifyJSONFile":        VerifyJSONFile,
		"StartAgentScriptName":  StartAgentScriptName,
	}
